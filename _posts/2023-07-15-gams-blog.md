...
````
  4.463735 seconds (12.99 M allocations: 485.280 MiB, 4.66% gc time, 11.26% compilation time)
  4.002578 seconds (12.64 M allocations: 462.332 MiB, 3.29% gc time)
````
...
````
  2.080213 seconds (33.92 M allocations: 1.545 GiB, 18.52% gc time, 14.58% compilation time)
  1.695827 seconds (33.68 M allocations: 1.529 GiB, 20.03% gc time)
````
...
````
  1.275758 seconds (33.37 M allocations: 1.512 GiB, 29.81% gc time, 25.66% compilation time)
  0.897751 seconds (33.12 M allocations: 1.495 GiB, 35.45% gc time)
````
...
````
  1.059152 seconds (33.10 M allocations: 1.487 GiB, 32.24% gc time, 20.71% compilation time)
  0.813018 seconds (32.93 M allocations: 1.476 GiB, 38.89% gc time)
````
...
````
  0.151296 seconds (461.83 k allocations: 51.187 MiB, 15.93% gc time, 19.65% compilation time)
  0.120108 seconds (435.75 k allocations: 49.386 MiB, 21.98% gc time)
````
