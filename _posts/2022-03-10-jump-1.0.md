...
It is one of the [10 most popular Julia packages](https://juliahub.com/ui/Packages),
...
are over 250 Julia packages that depend on JuMP for things such as
...
Here is a timeline of JuMP's greatest hits:
