...
kinds of formalism, including constraint programming.
...
- The v0.6 release of [ConstraintProgrammingExtensions.jl](https://github.com/dourouc05/ConstraintProgrammingExtensions.jl).
  ...
  * Support for the FlatZinc file format, a standard in constraint programming
...
This is not the end of the journey. Although MathOptInterface and JuMP are nearing
