...
To register for JuMP-dev 2020, [purchase a ticket](https://www.eventbrite.com/e/jump-dev-2020-tickets-99226534235).
...
Note that if we are forced to cancel the physical event, all tickets will be refunded.

### Dinner | Tuesday 19th

Dinner will be following Tuesday's events at [Restauration Nouvelle](https://restauration-nouvelle.be/en/etablissement/brasserie-rn-louvain-la-neuve-2/).

Choose a workshop ticket with the dinner option if you would like to attend.

Note that there are a limited number of dinner tickets, and first preference
